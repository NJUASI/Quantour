...
public class ChartServiceImpl extends UnicastRemoteObject implements ChartService {
     ...
     */
    public ChartServiceImpl() throws RemoteException {
     ...
     */
    @Override
    public Map<Integer, Iterator<Double>> getAveData(ChartShowCriteriaVO chartShowCriteriaVO, int[] days) throws RemoteException, DateShortException {

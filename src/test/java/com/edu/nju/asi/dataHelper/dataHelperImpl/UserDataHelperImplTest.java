...
public class UserDataHelperImplTest {
    ...
    public void get() throws Exception {
        assertEquals("5cc986cdeba8e0a5838864f7b51f1239",userDataHelper.get("ByronDong").getPassword());

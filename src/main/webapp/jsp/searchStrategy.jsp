                        ...
                        <div class="col-md-11">
                            <div class="row">
                                <div class="form-group row col-md-4">
                                    ...
                                    <div class='col-md-7'>
                                         <select id="blockTypes" name="blockTypes" class=" selectpicker show-tick form-control" style="padding-left: 0px"
                            ...
                            <div class="col-md-12">
                                <div class="row" style="margin-top: 20px">
                                    ...
                                    <!--右边数据框-->
                                    <div class="col-md-7 col-xs-12 pre-scrollable" style="height:200px;border-left: 1px solid slategray;max-height: 200px;">
                                        <label class="">
                                            选股条件:
                                        </label>

...
public class StrategyTypePanel extends TemplatePanel {
    ...
    public StrategyTypePanel(){
        ...
        setLayout(null);
        setBounds(adaptScreen(490,580+100,600,200));
        setBackground(new Color(35,39,44));


        label1= new MyLabel("形成期");
        label1.setLocation(60* WindowData.getInstance().getWidth()/1920,0*WindowData.getInstance().getHeight()/1030);
        label1.setVisible(true);
        add(label1);

        label2= new MyLabel("乖离率");
        label2.setLocation(60* WindowData.getInstance().getWidth()/1920,0*WindowData.getInstance().getHeight()/1030);
        ...
        label3.setLocation(275* WindowData.getInstance().getWidth()/1920,0*WindowData.getInstance().getHeight()/1030);
        add(label3);
        ...
        label4.setLocation(275* WindowData.getInstance().getWidth()/1920,0*WindowData.getInstance().getHeight()/1030);
        ...
        label8.setBounds(adaptScreen(175+60,140,140,35));
        add(label8);

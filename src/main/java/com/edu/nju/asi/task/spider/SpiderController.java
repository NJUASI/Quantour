...
public class SpiderController {
    ...
    public SpiderController(String rootPath, String stocksPath, String baseStockPath) {
    ...
    public void run() {
        ...
        //下载当天的基准股票数据
//        stockDownloader.downLoadBaseStock(baseStockPath, LocalDate.of(2017, 6, 3), LocalDate.now());
